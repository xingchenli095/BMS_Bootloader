...
.macro DispatchInterrupt isrid entry exit level corevar
 ...
 .thumb2
 .align 4
 .global OS_CORTEXM_IntReturnFromInterrupt
 .type OS_CORTEXM_IntReturnFromInterrupt, $function
OS_CORTEXM_IntReturnFromInterrupt:
 clrex
 cpsid f
 pop { r0, r1, r3 }
 OS_SETLEVEL r0, r2
...
OS_ReturnFromInterrupt_SkipEnableFpu:
 OS_MPU_SET_CTRL r0, r1
 pop {r4-r11,lr}
 cpsie i
 bx lr
 .size OS_CORTEXM_IntReturnFromInterrupt, . - OS_CORTEXM_IntReturnFromInterrupt
