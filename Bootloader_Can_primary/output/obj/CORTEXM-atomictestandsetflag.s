...
.macro OS_SETLEVEL level oldLevel
 ...
 msr basepri, level
 .endm
 .file "CORTEXM-atomictestandsetflag.s"
 .section ".os_text", "ax"
 .thumb2
 .global OS_AtomicTestAndSetFlag
 .align 4
 .type OS_AtomicTestAndSetFlag, $function
OS_AtomicTestAndSetFlag:
 dsb
 stmfd r13!, {r4}
_retry:
 ldrex r2, [r0]
 ...
 dsb
 bx lr
 .size OS_AtomicTestAndSetFlag, . - OS_AtomicTestAndSetFlag
