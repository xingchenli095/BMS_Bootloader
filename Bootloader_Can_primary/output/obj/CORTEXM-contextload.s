...
OS_kernelDataAddr:
 .word OS_kernel_ptr
 .type OS_CORTEXM_ContextLoad, $function
OS_CORTEXM_ContextLoad:
 clrex
 cpsid f
 mov sp, r0
 pop { r0, r1, r2 }
...
OS_SkipActivateSVC:
 mov r3, sp
 msr psp, r3
 OS_GET_KERNEL_PTR OS_kernelDataAddr, r1, r3
 ldr sp, [r1, #((0 + 4) + 4)]
 bx lr
 .size OS_CORTEXM_ContextLoad, . - OS_CORTEXM_ContextLoad
